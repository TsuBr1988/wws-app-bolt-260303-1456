...
const AtaTab: React.FC = () => {
  return (
    <div className="px-10 py-6 animate-fade-in pb-20">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-3xl font-bold text-brand-dark mb-2">Ata de Análise Crítica pela Direção</h2>
          <p className="text-gray-600">Registre as análises críticas do sistema de gestão</p>
        </div>
      ...
      <div className="bg-white p-8 rounded-xl shadow-sm border-2 border-gray-200 text-center">
        ...
        <p className="text-gray-500">Nenhuma ata de análise crítica registrada</p>
      </div>
    </div>
  );
};

export default AtaTab;
