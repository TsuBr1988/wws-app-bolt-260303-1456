      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600">
            Comissões efetivas recebidas por mês em {selectedYear}
          </p>
        </div>
            ...
            return (
              <div key={month} className="flex-1 flex flex-col items-center">
                <div className="relative w-full h-48 flex items-end">
                  <div 
                    className={`w-full rounded-t hover:opacity-80 transition-all cursor-pointer group ${
                  ...
                  >
                    ...
                    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10">
                      <div className="text-center">
                        ...
                        {department === 'Petrobras' && (
                          <div className="text-xs text-yellow-200">Taxa individual por contrato</div>
                        )}
                      </div>
                    </div>
                  </div>
