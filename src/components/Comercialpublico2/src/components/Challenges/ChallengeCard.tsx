          ...
          <div className="text-sm text-yellow-900 font-medium">
            <p>
              {expandedReward
                ...
                : truncateText(challenge.rewardAmount, 60)
              }
              {needsTruncation(challenge.rewardAmount, 60) && (
                <button
                  onClick={() => setExpandedReward(!expandedReward)}
                  className="ml-1 text-yellow-700 hover:text-yellow-900 font-medium"
                >
                  {expandedReward ? 'menos' : '... mais'}
                </button>
              )}
            </p>
          </div>
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-gray-700">
                Meta: {
                  ...
                  challenge.targetType === 'sales' ? formatCurrency(challenge.targetValue) + ' (total)' :
                  challenge.targetType === 'monthly_value' ? formatCurrency(challenge.targetValue) + ' (mensal)' :
            ...
            {challenge.status === 'active' && (
              <button
                ...
                className="text-sm text-blue-600 hover:text-blue-800 font-medium hover:underline cursor-pointer transition-colors"
              ...
              >
                {
                  ...
                  challenge.targetType === 'monthly_value' ? formatCurrency(currentProgress) :
            ...
            <>
              ...
              <div className="text-right">
                <span className={`text-xs font-semibold ${
                  getProgressPercentage() >= 100 ? 'text-green-600' :
                  getProgressPercentage() >= 75 ? 'text-blue-600' :
                  getProgressPercentage() >= 50 ? 'text-yellow-600' :
                  'text-orange-600'
                }`}>
                  {getProgressPercentage().toFixed(1)}% da meta cumprida
                </span>
              </div>
            </>
          )}
          ...
          <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
            ...
            {challenge.completionDate && (
              <p className="text-xs text-green-700 mt-1">
                Concluído em {formatDate(challenge.completionDate)}
              </p>
            )}
          </div>
        )}
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {challenge.participantsIds.map(participantId => {
                      ...
                      return (
                        <div key={participant.id} className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                          <img
