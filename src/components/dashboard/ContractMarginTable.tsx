...
import { ContractMarginTableRow } from '@/types/database';
import { DashboardService } from '@/services/dashboardService';

interface ContractMarginTableProps {
  data: ContractMarginTableRow[];
  months: { monthYm: string; monthLabel: string }[];
  onSave: (data: ContractMarginTableRow[]) => Promise<void>;
  loading: boolean;
}

export function ContractMarginTable({ data, months, onSave, loading }: ContractMarginTableProps) {
  const [tableData, setTableData] = useState<ContractMarginTableRow[]>(data);
