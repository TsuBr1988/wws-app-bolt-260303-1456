...
import { CleaningMaterialsTableRow } from '@/types/database';
import { DashboardService } from '@/services/dashboardService';

interface CleaningMaterialsTableProps {
  data: CleaningMaterialsTableRow[];
  months: { monthYm: string; monthLabel: string }[];
  onSave: (data: CleaningMaterialsTableRow[], deletedRows: CleaningMaterialsTableRow[]) => Promise<void>;
  loading: boolean;
}

export function CleaningMaterialsTable({ data, months, onSave, loading }: CleaningMaterialsTableProps) {
  const [tableData, setTableData] = useState<CleaningMaterialsTableRow[]>(data);
  const [deletedRows, setDeletedRows] = useState<CleaningMaterialsTableRow[]>([]);
