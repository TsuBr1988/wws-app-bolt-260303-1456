...
import { UniformsTableRow } from '@/types/database';
import { DashboardService } from '@/services/dashboardService';

interface UniformsTableProps {
  data: UniformsTableRow[];
  months: { monthYm: string; monthLabel: string }[];
  onSave: (data: UniformsTableRow[], deletedRows: UniformsTableRow[]) => Promise<void>;
  loading: boolean;
}

export function UniformsTable({ data, months, onSave, loading }: UniformsTableProps) {
  const [tableData, setTableData] = useState<UniformsTableRow[]>(data);
  const [deletedRows, setDeletedRows] = useState<UniformsTableRow[]>([]);
