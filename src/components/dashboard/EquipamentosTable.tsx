...
import { EquipamentosTableRow } from '@/types/database';
import { DashboardService } from '@/services/dashboardService';

interface EquipamentosTableProps {
  data: EquipamentosTableRow[];
  months: { monthYm: string; monthLabel: string }[];
  onSave: (data: EquipamentosTableRow[], deletedRows: EquipamentosTableRow[]) => Promise<void>;
  loading: boolean;
}

export function EquipamentosTable({ data, months, onSave, loading }: EquipamentosTableProps) {
  const [tableData, setTableData] = useState<EquipamentosTableRow[]>(data);
  const [deletedRows, setDeletedRows] = useState<EquipamentosTableRow[]>([]);
