/*
  # Fix copy_budget_as_new function - UUID type casting

  1. Changes
    - Fix uniforms: cast result back to UUID after JSONB lookup
    - Fix differentiated_benefits: cast result back to UUID after JSONB lookup
    - Conversion chain: UUID -> text (lookup) -> UUID (insert)
*/
