/*
  # Corrigir função copy_budget_as_new
  
  1. Problema
    - Sintaxe incorreta ao chamar get_next_budget_number
    - Estava usando "SELECT rpc FROM" em vez da sintaxe correta
  
  2. Solução
    - Usar SELECT INTO corretamente
    - Sintaxe: SELECT function_name(params) INTO variable
*/
...
BEGIN
  ...
  -- Gerar novo budget_number usando a função existente (sintaxe correta)
  SELECT get_next_budget_number(v_current_year) INTO v_new_budget_number;
