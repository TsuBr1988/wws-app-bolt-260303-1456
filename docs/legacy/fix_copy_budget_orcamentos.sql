/*
  # FIX: Atualizar função copy_budget_as_new no banco de orçamentos

  Este script deve ser aplicado no banco de orçamentos:
  ...
  IMPORTANTE: Execute este script no banco de orçamentos, não no banco principal!
*/

-- ============================================================================
-- 1. CRIAR/ATUALIZAR FUNÇÃO AUXILIAR: get_next_budget_number
-- ============================================================================
...
-- ============================================================================
-- 3. CRIAR NOVA FUNÇÃO CORRETA: copy_budget_as_new
-- ============================================================================
...
BEGIN
  ...
  -- ⚠️ IMPORTANTE: NÃO COPIA budget_calculations
  -- Esta tabela é um cache que será recalculada automaticamente pelo frontend
...
BEGIN
  IF EXISTS (
    ...
    WHERE proname = 'copy_budget_as_new'
    AND pronamespace = 'public'::regnamespace
  ) THEN
    RAISE NOTICE '✅ Função copy_budget_as_new criada/atualizada com sucesso!';
  ELSE
    RAISE EXCEPTION '❌ Erro: Função copy_budget_as_new não foi criada!';
  END IF;
END $$;
